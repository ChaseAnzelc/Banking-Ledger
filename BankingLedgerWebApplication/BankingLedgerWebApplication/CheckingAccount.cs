...
{
    public class CheckingAccount : Account //Child Class
    {

        public CheckingAccount(string accountIdentifier, int accountNumber, double balance) : base(accountIdentifier, accountNumber, balance)
        {
